# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 16:48:39 2022
Desarrollado por: Javier Andrés Duque Giraldo
CC: 1225089534
EDEQ 

Éste es un módulo de aprendizaje para probar los Radiobuttons.
"""
...
entrada1 = Entry(root, textvariable=num, bd=7, font="Helvetica 12")
...
boton1 = Button(root, text="Reaizar Operación", bg='goldenrod3', bd=5, command=operacion)
